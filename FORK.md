...
| Client notification POST returns `202`; `MCPConfig.streamable_tools` advertises `mcp_input_partial` tools and routes `notifications/tools/input_partial` to tool policy | current `zeno.5` wave | PR candidate (Streamable HTTP 202 posture) |
